# Gaussian Splatting VR with Natural Language Interface for Unity

A VR Gaussian Splatting renderer with **Natural Language Interface (NLI)** support. Built on [ninjamode's VR fork](https://github.com/ninjamode/Unity-VR-Gaussian-Splatting) and [Aras Pranckevičius' original implementation](https://github.com/aras-p/UnityGaussianSplatting).

Users can control multi-layer semantic 3D Gaussian Splatting scenes in VR using natural language — via text or voice.

- **Natural Language Control**: LLM-powered conversational commands to show/hide/tint/focus semantic layers
- **Multi-LLM Support**: DeepSeek, OpenAI, Qwen, Seed — switchable at runtime
- **Voice Input**: Windows Speech Recognition for hands-free VR interaction
- **VR Keyboard**: MRTK 4.0 virtual keyboard bridge for text input in VR

Built on top of existing capabilities from upstream:
- Multi-layer Gaussian Splatting rendering
- VR support (HTC Vive, Varjo Aero, Quest Pro/3)
- GPU sorting (AMD FFX / Device Radix Sort)


## Related

- [SEGS-iVR](https://github.com/NickEra/SEGS-iVR) — Semantic Gaussian Splatting training pipeline
- [Unity-VR-Gaussian-Splatting](https://github.com/ninjamode/Unity-VR-Gaussian-Splatting) — VR fork
- [UnityGaussianSplatting](https://github.com/aras-p/UnityGaussianSplatting) — Original renderer
...
MIT. See [LICENSE.md](LICENSE.md). Builds on work by [Aras Pranckevičius](https://github.com/aras-p/UnityGaussianSplatting) and [Constantin Kleinbeck](https://github.com/ninjamode/Unity-VR-Gaussian-Splatting). Uses [zanders3/json](https://github.com/zanders3/json) (MIT) and DeviceRadixSort by Thomas Smith.

Note: The original paper's [training software](https://github.com/graphdeco-inria/gaussian-splatting/blob/main/LICENSE.md) has separate academic/commercial licensing from INRIA.

<br>

This project builds on the VR rendering fork by Constantin Kleinbeck and the original Gaussian Splatting Unity implementation by Aras Pranckevičius. Please see the original readme below for more information:
